...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        time_window = "DEFAULT_VALUE"  # Replace with your desired default value
    else:
        time_window = str(sys.argv[1]).strip().upper()

    # Check for flare_class argument
    if len(sys.argv) < 3:
        print("Usage: python3 SolarFlareNet_train.py <time_window> <flare_class>")
        sys.exit(1)
